...
train_stm <- function(counts, celltypes, genes, labels, alpha, beta, K, D, n_dk, n_wk, num_threads = 1L, maxiter = 100L, verbal = TRUE, zero_gamma = FALSE, rand_gamma = TRUE, thresh = 0.00001, lr = 0.0001, nk_init = TRUE) {
    .Call(`_SpaTM_train_stm`, counts, celltypes, genes, labels, alpha, beta, K, D, n_dk, n_wk, num_threads, maxiter, verbal, zero_gamma, rand_gamma, thresh, lr, nk_init)
}
