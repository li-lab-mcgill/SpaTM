...
// train_stm
arma::mat train_stm(arma::sp_mat& counts, arma::vec& celltypes, arma::vec& genes, arma::vec& labels, const arma::mat& alpha, const arma::mat& beta, int K, int D, arma::mat& n_dk, arma::mat& n_wk, int num_threads, int maxiter, bool verbal, bool zero_gamma, bool rand_gamma, double thresh, double lr, bool nk_init);
RcppExport SEXP _SpaTM_train_stm(SEXP countsSEXP, SEXP celltypesSEXP, SEXP genesSEXP, SEXP labelsSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP KSEXP, SEXP DSEXP, SEXP n_dkSEXP, SEXP n_wkSEXP, SEXP num_threadsSEXP, SEXP maxiterSEXP, SEXP verbalSEXP, SEXP zero_gammaSEXP, SEXP rand_gammaSEXP, SEXP threshSEXP, SEXP lrSEXP, SEXP nk_initSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::sp_mat& >::type counts(countsSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type lr(lrSEXP);
    Rcpp::traits::input_parameter< bool >::type nk_init(nk_initSEXP);
    rcpp_result_gen = Rcpp::wrap(train_stm(counts, celltypes, genes, labels, alpha, beta, K, D, n_dk, n_wk, num_threads, maxiter, verbal, zero_gamma, rand_gamma, thresh, lr, nk_init));
    return rcpp_result_gen;
END_RCPP
}
// progress_bar
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_SpaTM_train_stm", (DL_FUNC) &_SpaTM_train_stm, 18},
